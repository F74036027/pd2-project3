...
void GameOver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (GameOver::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GameOver::quit)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void GameOver::quit(int _t1, int _t2)
{
